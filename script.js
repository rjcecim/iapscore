...
const salvar=()=>{
    ...
    cont.querySelectorAll(".card").forEach(card=>{
        const i=parseInt(card.dataset.index,10);
        ciclos[i]={
            FaturamentoRealizado:obterValorNumerico(card.querySelector("#faturamento-realizado")),
            FaturamentoAcelerador:obterValorNumerico(card.querySelector("#faturamento-acelerador")),
            AtivasRealizado:parseInt(card.querySelector("#ativas-realizado").value,10)||0,
            AtivasAcelerador:parseInt(card.querySelector("#ativas-acelerador").value,10)||0,
            CadastroPrataRealizado:parseInt(card.querySelector("#cadastro-prata-realizado").value,10)||0,
            CadastroPrataAcelerador:parseInt(card.querySelector("#cadastro-prata-acelerador").value,10)||0,
            QtdInicios:parseInt(card.querySelector("#qtd-inicios").value,10)||0,
            QtdCessadas:parseInt(card.querySelector("#qtd-cessadas").value,10)||0,
            Ciclos:parseInt(card.querySelector("#ciclos").value,10)||1,
            Grupos:parseInt(card.querySelector("#grupos").value,10)||1,
            AtivasCPVRealizado:parseInt(card.querySelector("#ativas-cpv-realizado").value,10)||0,
            AtivasCPVAcelerador:parseInt(card.querySelector("#ativas-cpv-acelerador").value,10)||0,
            AtivasMistasRealizado:parseInt(card.querySelector("#ativas-mistas-realizado").value,10)||0,
            AtivasMistasAcelerador:parseInt(card.querySelector("#ativas-mistas-acelerador").value,10)||0,
            TotalLideresIAP:parseInt(card.querySelector("#total-lideres-iap").value,10)||0,
            LideresComPontos:parseInt(card.querySelector("#lideres-com-pontos").value,10)||0
        };
    });
